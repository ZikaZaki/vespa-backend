...
class MotorcyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create motorcycle' do
    assert_difference('Motorcycle.count') do
      post motorcycles_url,
           params: { motorcycle: {
             description: @motorcycle.description,
             finance_fee: @motorcycle.finance_fee,
             model_name: @motorcycle.model_name,
             model_no: @motorcycle.model_no,
             production_date: @motorcycle.production_date,
             purchase_fee: @motorcycle.purchase_fee
           } }
    end
  ...
  test 'should update motorcycle' do
    patch motorcycle_url(@motorcycle),
          params: { motorcycle: {
            description: @motorcycle.description,
            finance_fee: @motorcycle.finance_fee,
            model_name: @motorcycle.model_name,
